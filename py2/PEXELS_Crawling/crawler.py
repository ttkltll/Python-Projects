...
cnt = 1  # first photo id, use to name the file
crawl_page_num = 10  # the number of page to crawl
page = 1  # initial crawling page
width=1920
height=1080
while page <= crawl_page_num:
    page_url = 'https://www.pexels.com/?format=js&page='+ str(page) # request .js file
    ...
    try:
        ...
        for each in photo_addr_list:
            ...
            print each
            #download
            pic_url = each + '?dl&fit=crop&w='+str(width)+'&h='+str(height)
            # print pic_url
